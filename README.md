...
Full-stack developer with experience across multiple languages and stacks — from low-level systems programming in C and C++ to modern web development with React and Node.js. Comfortable building backend services, working with relational and document databases, and shipping containerised apps via CI/CD.
